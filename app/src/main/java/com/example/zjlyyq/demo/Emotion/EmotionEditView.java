...
public class EmotionEditView extends TextView {

    public EmotionEditView(Context context) {
        super(context);
    }

    public EmotionEditView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public EmotionEditView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
